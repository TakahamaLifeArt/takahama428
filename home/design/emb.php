...
?>
	...
	<head prefix="og://ogp.me/ns# fb://ogp.me/ns/fb#  website: //ogp.me/ns/website#">
		...
		<meta name="Description" content="業界最速Tシャツへの刺繍ならタカハマライフアート！
		最短2日で納品が可能、一枚からでも簡単注文。ロゴや名入れネーム、持ち込みにも対応！
		ポロシャツ、エプロン、はっぴ、キャップ、スタッフジャンパーにも刺繍作成可能です。オリジナルTシャツ作成が早い" />
		...
		<div id="container">
			<div class="contents">
				...
				<div id="main" class="delivery">
					...
					<div class="nuikata">
						...
						<div class="item_1">
							...
							<div class="navi_inner">
								<img class="top3" src="img/other/shi_sewing_01.jpg" width="90%">
								<figcaption class="nui">デザインの端と端を縫う方法です。<br>ネームなど基本的にはこの縫い方で刺繍表現した方が綺麗に仕上がります。 綺麗に縫える幅は1mm～10mm程です。
									<br>10mm以上の場合には、タタミ縫いを用います。</figcaption>
							</div>
							<div class="navi_inner">
								<img class="top3" src="img/other/shi_sewing_02.jpg" width="90%">
								<figcaption class="nui">畳みの目の様に細かく縫う方法です。<br>縫い幅が10mm以上の時や、 刺繍を立体的に見せたい場合に土台部分で使われます。
									<br> サテン縫いより強度が良い縫い方になります。
								</figcaption>
							</div>
						</div>
					</div>
					...
					<div class="item_1">
						<div class="navi_inner">
							<img class="top3" src="img/other/shi_sewing_03.jpg" width="90%">
							<figcaption class="nui">点線で表現する方法です。<br>1mm以下のデザインを表現する場合に使われます。
								<br>小さなマークや文字にも、よく使われます。<br> 写真の雲と湖の水をステッチ縫いで表現しています。
							</figcaption>
						</div>
						<div class="navi_inner">
							<img class="top3" src="img/other/shi_sewing_04.jpg" width="90%">
							<figcaption class="nui">立体感を出す手法です。<br>糸だけでは表現できないボリュームを ウレタンのクッション材を挟んでその上からサテン縫いを施し、と立体感を出しています。さらに光沢感や高級感を表現でき、オリジナル刺繍デザインをより一層際立たせることができます。
								<br>
								<p class="undertxt"><span style="color:#dc0000;">※</span>デザイン幅が5mm以上無いと立体的に見えにくいです。</p>
							</figcaption>
						</div>
					</div>
					...
					<div id="emb_date">
						...
						<div class="item_top3 row">
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_01.jpg" width="100%">
							</div>
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_02.jpg" width="100%">
							</div>
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_03.jpg" width="100%">
							</div>
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_04.jpg" width="100%">
							</div>
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_05.jpg" width="100%">
							</div>
							<div class="top3_inner col-6 col-sm-4">
								<img class="top3" src="img/other/shi_use_06.jpg" width="100%">
							</div>
						</div>
					</div>
					...
					<div id="emb_date2">
						<div id="emb_date">
							...
							<p class="undertxt"><span style="color:#dc0000;">※</span>3D刺繍の場合は、一箇所＋400円の追加料金をいただきます。</p>
