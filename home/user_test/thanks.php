    ...
    <body>
        ...
        <div id="container">
            <div class="contents">
                ...
                <div id="main">
                    <p id="thanks">ご注文ありがとうございます。<br>
                        <img src="img/sp_history_order_complete.jpg"></p>
                    <p>この後、弊社よりお申込みいただいた内容での お見積りメールを改めてお送りいたします。
                        <br> お客様からのお返事を
                        <span>確認後、追加・再注文確定
                        となりますので、必ずご返信</span>ください。</p>
                </div>
                <button type="button" class="btn_or btn">マイページTOPへ戻る</button>
