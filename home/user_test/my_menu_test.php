...
?>
    ...
    <head prefix="og: //ogp.me/ns# fb: //ogp.me/ns/fb#  website: //ogp.me/ns/website#">
        ...
        <meta property="og:description" content="タカハマライフアートのマイページ、メインメニュー画面です。こちらから、確認したい事項にすぐに移動できるので、安心して、オリジナルTシャツの追加注文などができます。是非ご活用ください。" />
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="./css/my_menu_test.css" />
        <style>
            .lightbox {
                display: none;
            }
    ...
    <body>
        ...
        <div id="container">
            <div class="contents">
                ...
                <div class="toolbar">
                    <div class="toolbar_inner clearfix">
                        <div class="pagetitle">
                            ...
                            <ul>
                                <li class="btn-group"><button class="add_btn" data-featherlight="#fl1"><i class="fa fa-question-circle" aria-hidden="true"></i>マイページとは</button></li>
                ...
                <div class="user_rank">
                    <p class="rankname"><img src="/user_test/img/sp_customer_rank_bronze.png" class="rank_img" width="60px">お客様は<a href=""><span class="bodtxt">ブロンズ会員</span></a>です</p>
                </div>
                <div class="button_fld">
                        <a href="http://test.takahama428.com/user_test/reorder_form.php">
                            <button class="btn add_btn" data-featherlight="#fl1">
                        ...
                        <a href="http://test.takahama428.com/user_test/order_list.php">
                            <button class="btn add_btn" data-featherlight="#fl1">
                ...
                <div class="button_fld">
                        <a href="http://test.takahama428.com/user_test/questionnaire.php">
                            <button class="btn add_btn" data-featherlight="#fl1">
