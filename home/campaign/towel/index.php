...
<html lang="ja">
	<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#  website: http://ogp.me/ns/website#">
		...
		<title>オリジナルタオルの作成・プリントが早い(短納期)　|　タカハマライフアート</title>
	...
	<body>
		...
		<div class="container-fluid">
			<?php include $_SERVER['DOCUMENT_ROOT']."/common/inc/globalnavi.php"; ?> </div>
			...
			<div class="contents" width="100%">
				...
				<div class="wrap">
					<div class="speed_plan">
						<h2>当日特急プランとは..</h2>
						<p><span class="red">12時まで</span>にお電話での注文確定をして頂ければ、最短で<span class="red">当日のお届けが可能</span>なプランです！</p>
					</div>
					...
					<div class="can_item">
						<!--							<div class="ball">当日発送可能なアイテムはこちら</div>-->
						<div class="balloon1">
							<p>当日発送可能なアイテムはこちら</p>
						</div>
						<div class="ok_item">
					...
					<div class="con_but"> <a href=""><button type="button" class="btn btn-outline-primary waves-effect"><img src="/common/img/home/main/sp_go_icon.png" width="40px" style="padding-right: 12px;padding-bottom: 2px;">このアイテムで注文する</button></a> </div>
						...
						<div class="ok_item_inner_3">
							<div class="image_inner">
								...
								<div class="image_in_in">
									...
									<p class="red posi_20">プリント範囲（ 版のサイズ ）</p>
									...
									<p class="red">他にもこんなプリントの方法ができます！</p>
							...
							<div class="image_inner">
								...
								<div class="image_in_in">
									...
									<p class="red posi_5">プリント範囲（ 版のサイズ ）</p>
