<div class="container-fluid">
	<div class="row hidden-xs-down">
		...
		<div class="col-6">
			...
			<ul class="item_ul">
				<li><a href="/items/?cat=1">Tシャツ</a></li>
				<li><a href="/items/?cat=3">ポロシャツ</a></li>
		...
		<div class="col-4 hidden-md-down footer_tel_fax">
			...
			<!--<div class="">
				<a href="#!" class="btn-floating btn-large"><img src="/common/img/footer/Instagram.png" width="100%"></a>
				<a href="#!" class="btn-floating btn-large"><img src="/common/img/footer/facebook.png" width="100%"></a>
				<a href="#!" class="btn-floating btn-large"><img src="/common/img/footer/twitter.png" width="100%"></a>
				<a href="#!" class="btn-floating btn-large"><img src="/common/img/footer/line.png" width="100%"></a>
			</div>-->
			<!--<div class="">
				<a href="#!" class="btn-floating btn-large btn-ins"><i class="fa fa-instagram"></i></a>
				<a href="#!" class="btn-floating btn-large btn-fb"><i class="fa fa-facebook"></i></a>
				<a href="#!" class="btn-floating btn-large btn-tw"><i class="fa fa-twitter"></i></a>
				<a href="#!" class="btn-floating btn-large "><img src="/common/img/footer/line.png" width="100%"></a>
			</div>-->
			<div class="">
	...
	<div class="hidden-lg-up hidden-xs-down mt-2 foot_sns_tel">
		...
		<div class="row">
			...
			<div class="col-sm-6 align-self-center footer_tel_fax_2">
				<p class="tel_red"><a href="tel:0120130428">TEL : 0120-130-428</a><span class="min">受付時間：平日10:00-18:00</span></p>
				<p>FAX : 03-5670-0730 <span class="min">受付時間：24時間受付</span></p>
				<a class="button_contact" href="/contact/">お問い合わせ</a>
			</div>
		</div>
	</div>

	<nav class="row hidden-sm-up">
		<div class="col">
			<ul class="list-group">
				<li class="list-group-item list-group-item-action flex-column">
					<a href="tel:0120130248">
						<!--<i class="fa fa-phone" aria-hidden="true"></i>-->
						<img src="/common/img/footer/sp_tel_f.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="//www.instagram.com/takahamalifeart/">
						<!--<i class="fa fa-instagram" aria-hidden="true"></i> Instagram-->
						<img src="/common/img/footer/sp_Instagram.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="//twitter.com/takahamalifeart">
						<!--<i class="fa fa-twitter"></i> Twitter-->
						<img src="/common/img/footer/sp_twitter.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="/corporate/overview.php">
						<!--会社概要-->
						<img src="/common/img/footer/sp_company.jpg" width="100%">
					</a>
				</li>
			</ul>
		</div>
			...
			<ul class="list-group">
				<li class="list-group-item list-group-item-action flex-column">
					<a href="/contact/">
						...
						<img src="/common/img/footer/sp_mail_f.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="//ja-jp.facebook.com/takahamalifeart">
						<!--<i class="fa fa-facebook-official" aria-hidden="true"></i> Facebook-->
						<img src="/common/img/footer/sp_facebook.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="/contact/line/">
						<!--<i class="fa fa-twitter"></i> LINE-->
						<img src="/common/img/footer/sp_line.jpg" width="100%">
					</a>
				</li>
				<li class="list-group-item list-group-item-action flex-column">
					<a href="/corporate/transactions.php">
						<!--<span>特定商取引法</span>-->
						<img src="/common/img/footer/sp_law.jpg" width="100%">
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="row">
		...
		<!--<div class="col-sm-6">
			<div class="row">
				...
				<p class="w-100"></p>
				<p class="col text-left pl-3"><span><i class="fa fa-fax" aria-hidden="true"></i></span>03-5670-0730</p>
...
<div class="footer-copyright">
	<div class="container-fluid">
		&copy; 2017 Copyright: <a href="/" class="copyright"> オリジナルTシャツ屋 </a> All rights reserved.<br>【掲載の記事・写真・イラストなどの無断複写・転載等を禁じます。】
	</div>
</div>
