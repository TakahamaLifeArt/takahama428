...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'../../common/lightbox/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'../../common/lightbox/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'../../common/lightbox/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'../../common/lightbox/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'../../common/lightbox/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
