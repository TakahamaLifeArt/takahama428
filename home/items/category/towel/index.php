	...
	<body>
		...
		<div id="container">
			...
			<div class="contents">
				...
				<p><a href="/campaign/towel/extrabig.php"><img src="img/list_extrabig.jpg" class="hidden-xs-down"></a></p><br>
				<p><a href="/campaign/towel/extrabig.php"><img src="img/sp_list_extrabig.jpg"  class="hidden-sm-up" width="100%"></a></p><br>
				<?php echo $tagList; ?>
