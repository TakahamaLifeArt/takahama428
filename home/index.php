				...
				<div class="carousel-inner justify-content-center" role="listbox">
					<div class="carousel-item active hero-carousel__cell hero-carousel__cell--1">
						...
						<div class="carousel-caption">
							<p class="text_02">1枚1枚、職人がプリントする</p>
							<p class="text_01">オリジナルTシャツ</p>
							<p class="psn_btn"><a href="/order/" class="check btn btn-info adj waves-effect waves-light" type="button">
					...
					<div class="carousel-item hero-carousel__cell hero-carousel__cell--2">
						...
						<div class="carousel-caption">
							<p class="text_01">業界最速!<br class="hidden-sm-up">今日届くオリジナルTシャツ</p>
		...
		<main class="container">
			...
			?>
				...
				<div class="item_category">
					...
					<p>400種類以上の豊富なアイテムにお客様のデザインをオリジナルプリントできます。</p>
					...
					<section class="hidden-xs-down">
						...
						<div>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/t-shirts/">
<img src="/items/img/item_01.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/polo-shirts/">
<img src="/items/img/item_03.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/towel/">
									<img src="/items/img/item_08.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/sweat/">
                                    <img src="/items/img/item_02.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/sportswear/">
                                    <img src="/items/img/item_04.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/long-shirts/">
                                   <img src="/items/img/item_05.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/outer/">
                                    <img src="/items/img/item_06.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/ladys/">
                                    <img src="/items/img/item_07.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/tote-bag/">
                                   <img src="/items/img/item_09.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/apron/">
                                    <img src="/items/img/item_10.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/baby/">
                                   <img src="/items/img/item_11.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/overall/">
                                 <img src="/items/img/item_12.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/goods/">
                                    <img src="/items/img/item_15.jpg" width="100%"></a>
							...
							<div class="navi_inner_2 btn">
								<a class="dropdown-item" href="/items/category/cap/">
                                    <img src="/items/img/item_14.jpg" width="100%"></a>
...
<img src="/items/img/item_03.jpg" width="100%"></a>
					...
					<div class="top_02">
						...
						<p>WEB上で、すぐにお届け日とオリジナルTシャツの概算を調べることができます。</p>
							...
							<div class="col bk">
								<a href="/delivery/" class="check btn_01 top_3 top_item_flex">
									...
									<div class="bk_area">
										...
										<p class="btn_arrea">お届け日を調べる</p><i class="fas fa-caret-right"></i>
									</div>
								</a>
							</div>
							...
							<div class="col bk">
								<a href="/price/estimate.php" class="check btn_01 top_3 top_item_flex">
									...
									<div class="bk_txt">
										...
										<p class="btn_arrea txt_space">見積もりをする</p><i class="fas fa-caret-right"></i>
									</div>
								</a>
							</div>
						</div>
