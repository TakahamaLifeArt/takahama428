					...
					<section id="cart">
						...
						<section id="manuscript">
							...
							{% } %}
								...
								<div class="imega_select">
									<h3>イメージ画像について</h3>
									<div class="cart_inner imega">
										<div class="form-group_2 block">
											<div class="imega_sel">
												<label>
									<input type="radio" value="ahead" name="imega">
									イメージ画像を確認してから注文を確定する
											...
											<div class="imega_sel_02">
												<label>
									<input type="radio" value="rear" name="imega">
									イメージ画像を作成しないで注文する
								</label>
						...
						<section id="delivery">
							...
							<div class="cart_inner">
								...
								<div class="date_sel">
									...
									<!--           イメージ画像選択により表示-->
									<p class="note" id="imega_ahead"><span class="red_mark">※</span>イメージ画像作成に３営業日いただいております。特急でのご対応は出来ませんのでご了承ください。</p>
