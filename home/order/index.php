								...
								<form name="form1" class="e-mailer">
									...
									<ul>
										...
										<li>
											...
											<p><input type="text" name="addr1" id="addr1" class="p-locality p-street-address" value="<?php echo $user['addr1']; ?>" placeholder="例)葛飾区新小岩" maxlength="56" /></p>
											<p><input type="text" name="addr2" id="addr2" value="<?php echo $user['addr2']; ?>" placeholder="例)1-2-3 マンション・ビル名" maxlength="32" /></p>
										</li>
									</ul>
								</form>
								<form name="form2" class="e-mailer" onsubmit="return false">
									<ul>
										...
										<li id="shipping_addr">
											...
											<p>
												<input type="text" id="deli_addr1" class="p-locality p-street-address" value="<?php echo $user['deli_addr1']; ?>" placeholder="例)葛飾区新小岩" maxlength="56" />
											</p>
											<p>
												<input type="text" id="deli_addr2" value="<?php echo $user['deli_addr2']; ?>" placeholder="例)1-2-3 マンション・ビル名" maxlength="32" />
											</p>
										</li>
									</ul>
								</form>
									...
									<form name="form3" class="e-mailer" onsubmit="return false;">
										<ul>
											...
											<li id="mem_shipping_addr">
												<h4 class=" ml-4">宛名</h4>
												<p>
													<input type="text" id="mem_deli_destination" value="<?php echo $user['mem_deli_destination']; ?>" placeholder="お届け先の宛名" />
												</p>
												...
												<p>
													<input type="text" id="mem_deli_addr1" class="p-locality p-street-address" value="<?php echo $user['mem_deli_addr1']; ?>" placeholder="例)葛飾区新小岩" maxlength="56" />
												</p>
												<p>
													<input type="text" id="mem_deli_addr2" value="<?php echo $user['mem_deli_addr2']; ?>" placeholder="例)1-2-3 マンション・ビル名" maxlength="32" />
												</p>
											</li>
										</ul>
									</form>
