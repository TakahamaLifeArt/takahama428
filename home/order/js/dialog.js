...
$(function(){
	...
	$('.cashflow').on("click", function () {
		...
		msg += '<h3>銀行振込</h3>';
		msg += '<p class="payttl">下記の口座にご注文確定日の翌営業日午前中までにお振込をお願い致します。当日特急プラン、翌日プランの場合はご注文確定後すぐのお振込をお願い致します。（土日祝は入金確認ができないのでご注意ください）お振込手数料は、お客様のご負担とさせていただいております。</p>';
		...
		msg += '<div class="paylist">';
		msg += '<h3>カード決済</h3>';
		msg += '<p class="payttl">ご注文確定日の翌営業日午前中までにカードのご決済をお願い致します。当日特急プラン、翌日プランの場合はご注文確定後すぐのご決済をお願い致します。カード決済確認後、商品を発送致します。（土日祝は決済確認ができないのでご注意ください）</p>';
		msg += '<p class="txt_sml"><span class="red_txt">※</span>お客様のカード決済が遅れてご指定の納品日に商品の到着が間に合わなかった場合、当方では一切責任を負いかねますのでご了承ください。</p>';
		...
		msg += '<div class="paylist">';
		msg += '<h3>後払い</h3>';
		msg += '<p class="payttl">商品の到着を確認してから後払いができる、安心・簡単な決済方法です。</p>';
		msg += '<p class="payttl">※法人のお客様のみのご対応となります。学生、個人でご注文される方はご利用できません。詳細は以下のバナーをクリックしてご確認下さい。';
		msg += '<div class="later"><img alt="banner,later" src="./img/pay_np.png" width="100%"></div>';
		msg += '<p class="payttl">法人/個人事業主を対象とした掛け払いサービスです。（月末締め翌月末請求書払い） 請求書は、株式会社ネットプロテクションズからご購入の翌月第4営業日に発行されます。 </p>';
		msg += '<p class="payttl">月額最大300万円までお取引可能です。 請求書に記載されている銀行口座または、コンビニの払込票でお支払いください。  </p>';
		msg += '<p class="payttl">※銀行振込の際の振込手数料はお客様にてご負担ください。  請求代行のため代金債権は同社へ譲渡されます。  </p>';
		msg += '</div>';
		msg += '</div>';
		msg += '<button class="pop_btn_close btn waves-effect waves-light" data-dismiss="modal"><i class="fa fa-times-circle mr-1" aria-hidden="true"></i>閉じる</button>';
	...
	$('#imega_desc').on("click", function () {
		...
		msg += '<p><span class="red_txt">※</span>イメージ画像作成後にご注文をキャンセルされた場合、キャンセル料としてイメージ画像作成1,500円（税別）+デザイン料（必要な場合）がかかります。キャンセル受付日より3日以内にお支払いください。</p>';
		msg += '</div>';
		msg += '</div>';
		msg += '<button class="pop_btn_close btn waves-effect waves-light" data-dismiss="modal"><i class="fa fa-times-circle mr-1" aria-hidden="true"></i>閉じる</button>';
